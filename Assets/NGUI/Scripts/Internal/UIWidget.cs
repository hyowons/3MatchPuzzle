...
public class UIWidget : UIRect
{
	...
	virtual public void WriteToBuffers (BetterList<Vector3> v, BetterList<Vector2> u, BetterList<Color32> c, BetterList<Vector3> n, BetterList<Vector4> t)
	{
		if( n != null && t != null )
		{
		...
		{
			geometry.WriteToBuffers(v, u, c, null, null);
		}
	}
