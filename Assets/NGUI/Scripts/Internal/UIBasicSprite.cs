...
public abstract class UIBasicSprite : UIWidget
{
	...
	[HideInInspector][SerializeField] protected bool mIsGray  = false; // added
	[HideInInspector][SerializeField] protected float mBrightness = 1.0f; // added
...
#region Fill Functions
	...
	override public void WriteToBuffers (BetterList<Vector3> v, BetterList<Vector2> u, BetterList<Color32> c, BetterList<Vector3> n, BetterList<Vector4> t)
	{
		if( isGray )
		{
			float fGray = 1.0f;

			geometry.mAddEffectNormal = new Vector3( fGray, mBrightness, 0.0f );
			geometry.WriteToBuffers(v, u, c, n, null);
		}
		else
		{
			geometry.mAddEffectNormal = new Vector3( 0.0f, mBrightness, 0.0f );
