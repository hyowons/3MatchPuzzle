...
namespace XLua
{
    public partial class DelegateBridge : DelegateBridgeBase
    {
		...
		public UnityEngine.Vector3 __Gen_Delegate_Imp1(object p0)
		{
#if THREAD_SAFE || HOTFIX_ENABLE
            lock (luaEnv.luaEnvLock)
            {
		...
		public MapTile __Gen_Delegate_Imp2(object p0)
		{
#if THREAD_SAFE || HOTFIX_ENABLE
            lock (luaEnv.luaEnvLock)
            {
                ...
                MapTile __gen_ret = (MapTile)translator.GetObject(L, errFunc + 1, typeof(MapTile));
                LuaAPI.lua_settop(L, errFunc - 1);
                return  __gen_ret;
#if THREAD_SAFE || HOTFIX_ENABLE
            }
		...
		public int __Gen_Delegate_Imp4(object p0, eTileDir p1)
		{
#if THREAD_SAFE || HOTFIX_ENABLE
            lock (luaEnv.luaEnvLock)
            {
		...
		public eBubbleType __Gen_Delegate_Imp5(object p0)
		{
#if THREAD_SAFE || HOTFIX_ENABLE
            lock (luaEnv.luaEnvLock)
            {
                ...
                eBubbleType __gen_ret;translator.Get(L, errFunc + 1, out __gen_ret);
                LuaAPI.lua_settop(L, errFunc - 1);
                return  __gen_ret;
#if THREAD_SAFE || HOTFIX_ENABLE
            }
		...
		public bool __Gen_Delegate_Imp10(object p0, float p1)
		{
#if THREAD_SAFE || HOTFIX_ENABLE
            lock (luaEnv.luaEnvLock)
            {
		...
		public override Delegate GetDelegateByType(Type type)
		{
		    ...
		    if (type == typeof(BubbleScript.GetLuaUpdateCB))
			{
			    return new BubbleScript.GetLuaUpdateCB(__Gen_Delegate_Imp0);
			}
